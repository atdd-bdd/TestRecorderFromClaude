...
public class BusinessRulesStepDefinitions {
    ...
    public BusinessRulesStepDefinitions(TestContext context) {
        this.context = context;
    }

    @Given("test exists with")
    public void test_exists_with(DataTable dataTable) {
    ...
    public void update_test_from_test_run(DataTable dataTable) {
        List<Map<String, String>> rows = dataTable.asMaps();
        ...
        for (Map<String, String> row : rows) {
            ...
            context.getTestService().updateTestFromTestRun(test, oldLastResult, oldDateLastRun, 
    ...
    public void update_test_from_test_run_sequence(DataTable dataTable) {
        List<Map<String, String>> rows = dataTable.asMaps();
